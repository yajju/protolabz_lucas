...
class MessengerController extends Controller
{
    public function index()
    {
        ...
        return view('merchants.messenger.index', compact('topics', 'title', 'unreads'));
    }
    ...
    public function createTopic()
    {
        ...
        return view('merchants.messenger.create', compact('users', 'unreads'));
    }
    ...
    public function showMessages(QaTopic $topic)
    {
        ...
        return view('merchants.messenger.show', compact('topic', 'unreads'));
    }
    ...
    public function showReply(QaTopic $topic)
    {
        ...
        return view('merchants.messenger.reply', compact('topic', 'unreads'));
    }
