            ...
            <aside class="left-sidebar">
                ...
                <div>
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                        <a class="sidebar-link @yield('merchants')" href="{{url('admin/merchants')}}" aria-expanded="false">
                            <span>
                        ...
                        <li class="sidebar-item">
                        <a class="sidebar-link @yield('transactions')" href="{{url('admin/transactions')}}" aria-expanded="false">
                            <span>
                        ...
                        <li class="sidebar-item">
                        <a class="sidebar-link @yield('reports')" href="{{url('admin/reports')}}" aria-expanded="false">
                            <span>
                        ...
                        <li class="sidebar-item">
                        <a class="sidebar-link @yield('support')" href="{{url('admin/support')}}" aria-expanded="false">
                            <span>
                        ...
                        <li class="sidebar-item">
                        <a class="sidebar-link @yield('documentation')" href="{{url('admin/documentation')}}" aria-expanded="false">
                            <span>
                        ...
                        <li class="nav-item dropdown">
                          ...
                          <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2">
                            <div class="message-body">
                              ...
                              <a href="{{url('admin/change-password')}}" class="d-flex align-items-center gap-2 dropdown-item">
